...
Честная инвентаризация «недоделанного» на конец Вехи 46 (папки, редактор строки, освобождение фреймов взяты).
...
4. Крупное: драйверы реального железа (AHCI/NVMe/xHCI+USB/NIC/UEFI-GOP) — покрывают ~80%
   ...
   Ближайший практичный: USB — начали с legacy-обхода (внешняя клава через BIOS в наш ps2.rs),
   настоящий xHCI-стек отложен как самая большая драйверная веха. ← следующее по железу
