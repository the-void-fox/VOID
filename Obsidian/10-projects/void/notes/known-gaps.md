...
Честная инвентаризация «недоделанного» на конец Вехи 50 (папки, редактор строки, освобождение фреймов, AHCI-диск, установка на диск, e1000-сеть, USB-клавиатура взяты).
...
4. Крупное: драйверы реального железа — покрывают ~80% PC своими силами:
   ...
   - **Хостить Linux-драйверы** (Genode-стиль) — для «длинного хвоста» железа X54C и вообще: его
     Atheros/Realtek NIC, EHCI-USB, wifi, GPU. Это закроет реальный ноут. ← следующее по плану
