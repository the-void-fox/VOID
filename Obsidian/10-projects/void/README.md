...
## Статус
**Фазы 0–3 закрыты (Вехи 1–22); Фаза 4 идёт (Вехи 23–38 закрыты).** Тезис ADR 0002 полон,
...
процессов (готово) → linux-abi (бэкенд B, готово). Дальше по принятому порядку:
бэкенд C (wasi) → декларативный init → реальное железо.
