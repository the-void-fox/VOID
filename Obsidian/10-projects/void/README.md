...
## Статус
**Фазы 0–3 закрыты (Вехи 1–22); Фаза 4 идёт (Вехи 23–37 закрыты).** Тезис ADR 0002 полон,
...
ребута с тем же стеком и кучей.
...
процессов (готово). Дальше по принятому порядку: бэкенды B/C → декларативный
init → реальное железо.
