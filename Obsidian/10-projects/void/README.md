...
## Статус
**Фазы 0–3 закрыты (Вехи 1–22); Фаза 4 идёт (Вехи 23–29 закрыты).** Тезис ADR 0002 полон,
...
форк rust — сабмодуль `vendor/rust` под std-порт. План пакетов — [[void-pkg]].
...
бенчи и README (готово) → host-мост + NAR (готово) → контракт запуска процесса (Веха 30)
→ std-порт (Веха 31) → uutils (Веха 32). Дальше: сеть, checkpoint процессов,
