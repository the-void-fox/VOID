...
#\n\
# \"builtin:logo\" (Веха 141) — знак VOID, нарисованный на месте: файла не нужно, любой экран\n\
# получает свой точный размер. Это и стоит здесь по умолчанию.\n\
#\n\
