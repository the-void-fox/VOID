...
impl<'a> Ui<'a> {
    ...
    pub fn dropdown(&mut self, r: Rect, fillet: i32) {
        ...
        // Центр дуги — во внутреннем углу квадратика, как и у полосы: сверху слева это его НИЗ
        // (цвет затекает под полосу), снизу справа — его ВЕРХ (цвет затекает к краю экрана).
