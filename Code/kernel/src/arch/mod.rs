...
//!   вытеснения; величина кванта — дело арха: таймбазы разные), `timer_arm_at(срок)` — разбудить
//!   В ЭТОТ момент по шкале `now_ticks` (Веха 145.4: сон по сроку не должен ждать конца кванта;
//!   x86 — TSC-deadline или измеренный one-shot, riscv — SBI TIME как есть), `timer_hz` — ЧАСТОТА монотонного
