...
#
# Сценарные прогоны (снимки экрана, клавиши, мышь) — это `tools/screenrun.py`; два VOID'а на
# одном проводе — `tools/netlab.py`; положить файл в store с хоста — `tools/void-store-import`.
set -euo pipefail
